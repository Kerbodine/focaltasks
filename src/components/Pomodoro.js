  ...
  return (
    <div>
      <div className="flex aspect-square w-full flex-col items-center justify-center rounded-full border-2 border-gray-200">
        <p className="mt-4 mb-1 text-4xl font-medium text-gray-500">{`${minutes}:${seconds}`}</p>
      ...
      <div className="mt-4 flex justify-center gap-2">
        {/* <div className="mb-2 rounded-lg bg-gray-500 px-2 py-1 text-sm font-medium capitalize text-white">
          {mode}
        </div> */}
        {isPaused ? (
          <button
